...
@section('content')
  <main class="main-content">
    ...
    <section class="container contributions">
      ...
      <p class="contributions__subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim aliquam pellentesque facilisis egestas risus egestas sit gravida.</p>
